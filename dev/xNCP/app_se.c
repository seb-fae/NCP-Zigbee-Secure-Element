...
// -----------------------------------------------------------------------------
sl_se_command_context_t * get_ctx_ptr(void)
{
  return &cmd_ctx;
}

uint8_t * get_client_wrapped_key_buf_ptr(void)
{
...
uint8_t * get_client_buf_ptr(void)
{
  return(client_pubkey_buf);
}

uint8_t * get_server_buf_ptr(void)
{
  return(server_pubkey_buf);
}
/***************************************************************************//**
