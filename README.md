...
This project shows how to establish a secure TLS connection(using cipher suite TLS-ECDHE-ECDSA-WITH-AES-128-GCM-SHA256) to a remote server by taking advantage of the internal secure element of the EFR32MG21B. In this project EFR32 is also running a Zigbee NCP (Network Co-Processor).
