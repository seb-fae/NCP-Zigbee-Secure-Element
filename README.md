...
This project shows how to establish a secure TLS connection to a server by taking advantage of the internal secure element of the EFR32MG21B running a Zigbee NCP (Network Co-Processor)
